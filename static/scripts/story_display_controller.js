...
function load_up_story_audio(chapter) {
	...
	if(chapter >= 1) {
		story_audio = new Audio("http://http://www.mybeedyeye.com/burke_and_hare/static/content/story_content/audio/location_' + chapter + '.mp3");
		
	} else {
		story_audio = new Audio("http://http://www.mybeedyeye.com/burke_and_hare/static/content/story_content/audio/intro.mp3");
	}
